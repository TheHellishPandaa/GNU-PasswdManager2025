...
def login_user():
    user = simpledialog.askstring("Login with master password", "Username:")
...
def show_panel(user):
    ...
    title = tk.Label(panel_frame, text="GNU-PasswdManager", font=("Arial", 28, "bold"))
    title.pack(pady=10)
...
login_button = tk.Button(login_frame, text="Login with master password", command=open_login, width=25)
